    ...
    <div className="bg-surface-page min-h-screen text-ink py-8">
      <Container>
        ...
        <div className="space-y-8">
          ...
          {projects.length === 0 ? (
            <div className="bg-surface border border-line rounded-[20px] p-12 text-center space-y-3 shadow-sm">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {projects.map((proj) => (
                <div key={proj.id} className="bg-surface border border-line rounded-[20px] overflow-hidden shadow-sm hover:shadow-md transition-shadow flex flex-col">
