...
import { ShoppingCart, Building2, Truck, ShieldCheck } from 'lucide-react';
      ...
      <div className="bg-white border border-gray-200 rounded-xl p-5 sm:p-6 shadow-xs">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-8 items-start">
          ...
          <div className="lg:col-span-6 space-y-5">
            ...
            {/* Price Box */}
            <div className="p-4 rounded-lg bg-[#F8F9FA] border border-gray-200 flex flex-wrap items-center justify-between gap-3">
              <div>
                <span className="text-[11px] text-gray-500 font-semibold uppercase block mb-0.5">Chakana Narx</span>
            ...
            <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3 pt-1">
              ...
              <Button
                ...
                className="flex-1 gap-2 font-bold text-sm bg-brand-red hover:bg-brand-red-dark text-white rounded-lg shadow-xs"
              >
